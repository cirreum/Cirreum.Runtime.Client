...
/// </remarks>
sealed class JSAppModule : IJSAppModule, IJSAppInterop, IDisposable {
	...
	public ResolvedDateTimeFormatOptions GetInternationalFormats() {
		return this.module!.Invoke<ResolvedDateTimeFormatOptions>("getInternationalFormats");
	}
	...
	public AppAuthInfo GetAuthInfo() {
		return this.module!.Invoke<AppAuthInfo>("getAuthInfo");
	}
