...
// No-Auth Ping Api
// we provided a specific client name instead of the default
//builder.AddRemoteClient<PingClient>(o => {
//	o.ServiceUri = new("https://localhost:7040/");
//	o.AuthorizationHeader = AuthorizationHeaderSettings.Anonymous;
//}, "PingApiNoAuth");
...
builder.AddClientState(state => state
	...
	.RegisterState<INavMenuState, NavMenuState>()
	.RegisterState<IInitializationState, InitializationState>()
